...
Your Task:
This is a function problem. You are required to complete the function josephus that takes two parameters n and k and returns an 
integer denoting safe position .
...
public class Josephus
{
	...
	{
		System.out.println("The last survival :" + theLastSurvival(3, 2));
		System.out.println("The last survival :" + theLastSurvival(5, 3));
	}

	public static int theLastSurvival(int n, int k) {
		if (n == 1) return 1;
		
		return ((theLastSurvival(n-1, k)+k-1)%n) +  1;
	}
}
